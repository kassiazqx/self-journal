...
- 2026-04-18 · 代码session · Task 9 完成：user_contacts 新增 group_name 分组字段；loadContacts SELECT 补 group_name（根因修复"保存未生效"）；SettingsPage 联系人管理新增分组输入；RecordDetail 人物 sheet 按分组展示；同步卡：docs/sync-cards/2026-04-18-people-coreneeds-sync.md
